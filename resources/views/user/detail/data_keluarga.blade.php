<x-app-layout>
                    ...
                    <form action="{{ route('anggota.keluarga.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-md-6">
                                    <label for="nama_anggota_keluarga" class="form-label">Nama<span style="color: red">*</span></label>
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-md-6">
                                    <label for="status_kehidupan" class="form-label">Status Kehidupan<span style="color: red">*</span></label>
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    <label for="keluarga_image_link" class="form-label">Link Foto (Media Sosial, Drive, dll)</label>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="{{ route('anggota.keluarga.update', $anggota->id) }}" method="POST"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-4">
                                    <div class="col-12">
                                        <label for="keluarga_image_link_edit" class="form-label">Link Foto (Media Sosial, Drive, dll)</label>
                                        <div class="d-flex align-items-center gap-3">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('pasangan.anggota.keluarga.store') }}" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    <label for="partner_image_link" class="form-label">Link Foto (Media Sosial, Drive, dll)</label>
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="" class="img-thumbnail image-preview"
                                            style="display: none; width: 80px; height: 80px; object-fit: cover; border-radius: 10px;">
                                        <input class="form-control" type="url" id="partner_image_link" name="partner_image_link"
                                            placeholder="https://example.com/image.jpg" onchange="previewImageFromLinkPartner()">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('pasangan.anggota.keluarga.update', $partner->id) }}" method="POST"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-12">
                                            <label for="foto_pasangan_link_edit" class="form-label">Link Foto (Media Sosial, Drive, dll)</label>
                                            <div class="d-flex align-items-center gap-3">
                                                @if ($partner->photo)
    ...
    <div class="bg-gray-100 mb-3">
        <div class="py-3 px-3 md:px-5 bg-white rounded-lg shadow-md">
            @if ($trahs->trah_name)
                <h5 class="d-flex flex-column fw-bold mb-0">
                    {{ $trahs->trah_name }}
                                                    ...
                                                    <table class="table table-hover mb-0" id="datatables">
                                                        ...
                                                        <tbody>
                                                            @forelse ($anggota_keluarga as $anggota)
                                                                <tr
                                                                    class="{{ $loop->iteration % 2 == 1 ? 'odd-row' : 'even-row' }}">
                                                                    ...
                                                                    <td class="text-center"
                                                                        ...
                                                                        <div
                                                                            class="d-flex align-items-center justify-content-center">
                                                                            <span
                                                                                class="fw-medium">{{ $anggota->jenis_kelamin }}</span>
                                                                        </div>
                                                                    </td>
                                                                    <td class="text-center"
                                                                        style="border: 1px solid #dee2e6;">
                                                    ...
                                                    <table class="table table-hover mb-0" id="datatables">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @forelse ($anggota_keluarga as $anggota)
                                                                @foreach ($anggota->partners as $partner)
                                                                    <tr
                                                                        class="{{ $counter % 2 == 1 ? 'odd-row' : 'even-row' }}">
                                                                        <td class="text-center text-muted fw-medium"
                                                                            style="border: 1px solid #dee2e6;">
                                                                            {{ $counter++ }}
                                                                        </td>
                                                                        ...
                                                                        <td class="text-center"
                                                                            ...
                                                                            <div
                                                                                class="d-flex align-items-center justify-content-center">
                                                                                <span
                                                                                    class="fw-medium">{{ $partner->jenis_kelamin }}</span>
                                                                            </div>
                                                                        </td>
                                                                        <td class="text-center"
                                                                            style="border: 1px solid #dee2e6;">
                                                            ...
                                                            @empty
                                                                <tr>
                                                                    <td colspan="6" class="text-center py-5"
                                                                        ...
                                                                        <div class="text-muted">
                                                                            <i class="fas fa-inbox fa-3x mb-3"></i>
                                                                            <h5>Belum ada data pasangan</h5>
                                                                            <p>Mulai dengan menambahkan pasangan pertama</p>
                                                                            <button type="button" class="btn btn-primary"
                                                                                data-bs-toggle="modal"
                                                                                data-bs-target="#addPartnerModal">
                                                                                <i class="fas fa-plus me-2"></i>Tambah
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-6">
                                                        <div class="dataTables_info" id="datatables_info" role="status"
                                                            ...
                                                            @endphp
                                                            Showing 1 to {{ $totalPartners }} of {{ $totalPartners }}
                                                            entries
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
